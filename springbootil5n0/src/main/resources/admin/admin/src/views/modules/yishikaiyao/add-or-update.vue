<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服用剂量" prop="fuyongjiliang">
          <el-input v-model="ruleForm.fuyongjiliang" 
              placeholder="服用剂量" clearable  :readonly="ro.fuyongjiliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服用剂量" prop="fuyongjiliang">
              <el-input v-model="ruleForm.fuyongjiliang" 
                placeholder="服用剂量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服用周期" prop="fuyongzhouqi">
          <el-input v-model="ruleForm.fuyongzhouqi" 
              placeholder="服用周期" clearable  :readonly="ro.fuyongzhouqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服用周期" prop="fuyongzhouqi">
              <el-input v-model="ruleForm.fuyongzhouqi" 
                placeholder="服用周期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='fuyongjiliang'){
            this.ruleForm.fuyongjiliang = obj[o];
	    this.ro.fuyongjiliang = true;
            continue;
          }
          if(o=='fuyongzhouqi'){
            this.ruleForm.fuyongzhouqi = obj[o];
	    this.ro.fuyongzhouqi = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yishikaiyao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yishikaiyaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
