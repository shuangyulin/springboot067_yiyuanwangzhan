<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供应厂家" prop="gongyingchangjia">
          <el-input v-model="ruleForm.gongyingchangjia" 
              placeholder="供应厂家" clearable  :readonly="ro.gongyingchangjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供应厂家" prop="gongyingchangjia">
              <el-input v-model="ruleForm.gongyingchangjia" 
                placeholder="供应厂家" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="药品介绍" prop="yaopinjieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="药品介绍"
                  v-model="ruleForm.yaopinjieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yaopinjieshao" label="药品介绍" prop="yaopinjieshao">
                    <span>{{ruleForm.yaopinjieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="主治功能" prop="zhuzhigongneng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="主治功能"
                  v-model="ruleForm.zhuzhigongneng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuzhigongneng" label="主治功能" prop="zhuzhigongneng">
                    <span>{{ruleForm.zhuzhigongneng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaopinleixing = true;
          ...
          if(o=='yaopinjieshao'){
            this.ruleForm.yaopinjieshao = obj[o];
	    this.ro.yaopinjieshao = true;
            continue;
          }
          if(o=='zhuzhigongneng'){
	    ...
	    this.ro.zhuyishixiang = true;
          ...
          if(o=='gongyingchangjia'){
            this.ruleForm.gongyingchangjia = obj[o];
	    this.ro.gongyingchangjia = true;
            continue;
          }
          if(o=='shengchanriqi'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springbootil5n0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yaokuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yaokuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
